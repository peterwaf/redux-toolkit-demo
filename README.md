This is a simple React app built with Vite, demonstrating how to use Redux Toolkit with createAsyncThunk for asynchronous state management. The app includes:
